...
const mediaItems = [
  { type: 'image', src: '/assets/check.jpg', alt: 'Random Image 1' },
  ...
  return (
    <Box
      sx={{
        ...
        padding: 2, // Optional padding for additional space on sides
        display: 'flex',
          ...
          >
            ...
            {item.type === 'video' && (
              <Box
                ...
                sx={{
                  width: '100%',
                  height: Math.random() * 200 + 150, // Random height for videos as well
                  objectFit: 'cover',
                }}
              >
